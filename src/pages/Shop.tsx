...
export default function Shop() {
  ...
  useSeo({
    title: q ? `Search ${q} - Gunjan` : 'Shop Boys, Girls, Kids and Thermal Wear - Gunjan',
    description: 'Browse Gunjan boys innerwear, girls innerwear, kids essentials and thermal wear with size, color, price and thermal type filters.',
